		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-md-6 form-required">
					<label for="noOfUnits" class="control-label col-md-5">Client Type</label>
					<div class="col-md-7">
...
<div class="box-footer">
	 ...
	 <a href="<c:url value='/protected/clients/setups/clientslist'/> " class="btn btn-info pull-left">Cancel</a>
	 </div>
	</form>
	</div>